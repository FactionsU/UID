...
import dev.kitteh.factions.perms.selector.AllSelector;
import dev.kitteh.factions.perms.selector.FactionSelector;
import dev.kitteh.factions.perms.selector.PlayerSelector;
import dev.kitteh.factions.perms.selector.RelationAtLeastSelector;
import dev.kitteh.factions.perms.selector.RelationAtMostSelector;
import dev.kitteh.factions.perms.selector.RelationSingleSelector;
import dev.kitteh.factions.perms.selector.RoleAtLeastSelector;
import dev.kitteh.factions.perms.selector.RoleAtMostSelector;
import dev.kitteh.factions.perms.selector.RoleSingleSelector;
import dev.kitteh.factions.perms.selector.UnknownSelector;
