...
import dev.kitteh.factions.cmd.claim.CmdAutoClaim;
import dev.kitteh.factions.cmd.claim.CmdAutoUnclaim;
import dev.kitteh.factions.cmd.claim.CmdClaim;
import dev.kitteh.factions.cmd.claim.CmdClaimAt;
import dev.kitteh.factions.cmd.claim.CmdClaimFill;
import dev.kitteh.factions.cmd.claim.CmdClaimLine;
import dev.kitteh.factions.cmd.claim.CmdSafeunclaimall;
import dev.kitteh.factions.cmd.claim.CmdUnclaim;
import dev.kitteh.factions.cmd.claim.CmdUnclaimall;
import dev.kitteh.factions.cmd.claim.CmdUnclaimfill;
import dev.kitteh.factions.cmd.claim.CmdWarunclaimall;
import dev.kitteh.factions.cmd.money.CmdMoney;
import dev.kitteh.factions.cmd.relations.CmdRelationAlly;
import dev.kitteh.factions.cmd.relations.CmdRelationEnemy;
import dev.kitteh.factions.cmd.relations.CmdRelationNeutral;
import dev.kitteh.factions.cmd.relations.CmdRelationTruce;
import dev.kitteh.factions.cmd.role.CmdDemote;
import dev.kitteh.factions.cmd.role.CmdPromote;
