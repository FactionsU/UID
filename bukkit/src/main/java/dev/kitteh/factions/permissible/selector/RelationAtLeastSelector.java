...
public class RelationAtLeastSelector extends AbstractRelationSelector {
    ...
    public static final Descriptor DESCRIPTOR = new RelationDescriptor(NAME, Confs.tl().permissions().selectors().relationAtLeast()::getDisplayName, RelationAtLeastSelector::new);
