...
public class RelationSingleSelector extends AbstractRelationSelector {
    ...
    public static final Descriptor DESCRIPTOR = new RelationDescriptor(NAME, Confs.tl().permissions().selectors().relationSingle()::getDisplayName, RelationSingleSelector::new);
