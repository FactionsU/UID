...
import dev.kitteh.factions.command.defaults.CmdDues;
...
import dev.kitteh.factions.command.defaults.admin.CmdAdminRent;
...
public class CommandsRoot {
    ...
    private static void register() {
        ...
        registerInternal("dues", new CmdDues());
        ...
        if (Bukkit.getServer().getPluginManager().getPlugin("PlayerVaults") != null) {
        ...
        registerAdminInternal("rent", new CmdAdminRent());
